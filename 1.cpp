...
int main(){
    ...
    /* o jeito correto de se fazer o exercício da letra B seria: 
...
/*
6. a linha 16 imprime *ss, que na função, é inicializado como 0 
e soma i conforme x é divisível por i,
até que i se iguale a c.
7. a linha 19 decide se o número tem a característica ou não, tal 
que existe caso o quadrado da soma do resto da divisão deste por 100
